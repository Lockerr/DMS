...
class Document
  ...
  def generate
    ...
    for key in keys
      ...
      Rails.logger.info docbody.root.elements["*/w:p/w:fldSimple[@w:instr=' DOCPROPERTY  #{key.to_s}  \\* MERGEFORMAT ']"].elements['w:r'].elements['w:t'].text
    end
    
    
    unless object.class.to_s.downcase == 'dkp'
