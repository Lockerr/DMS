...
class Contract # < ActiveRecord::Base
  ...
  def attrs(client)

    {
            ...
            :car_model_name => "#{client.car.klasse.name} #{client.car.model.name}#{client.car.klasse.cedan}",
            :car_model_name_2 => "#{client.car.klasse.name} #{client.car.model.name}#{client.car.klasse.cedan}",
